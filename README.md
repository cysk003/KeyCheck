...
提示：该项目没有配置数据库，如果有需要请自行配置数据库，按照网上.net core的数据库配置教程来即可，你也可以使用AI辅助添加框架。  
项目使用微软的ORM框架，即EF Core，项目内也有安装该框架。你需要修改配置文件内的数据库连接字符串，以及完整配置数据库实体dbcontext相关类，然后在控制器里面使用这个context即可。  <br/>
**PKeyTool桌面端**  
在项目内找到文件夹PKeyTool_Desktop，把它打包下载下来，下载完后打开解决方案，直接编译运行即可跑起来。  
这是Windows桌面端的应用程序，使用的框架为.NET8 WPF。  
需要注意的是，该项目没有做本地已封密钥数据库，你可以自己编写代码加这个功能。
<br/>  
...
![PKTSS1](Screenshots/SS1.png)  
![PKTSS2](Screenshots/SS2.png)  

  
**PKeyTool桌面端**  
  
![PKTSS1](Screenshots/SS3.png)  
![PKTSS2](Screenshots/SS4.png)  
# 本站当前无广告，无推广，无付费 
